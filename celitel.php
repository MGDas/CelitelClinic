...
$Agreement = explode(' ', $_POST['appointmentTime'])[2];

$formObject = '{"ID":"medsite.loc-s1-1414471395","Number":"' . $Number. '","Date":"' . $Date . '","Name":"' . $Name . '","Surname":"' . $Surname . '","LastName":"' . $Lastname . '","Birthday":"' . $Birthday . '","Gender":"' . $Gender . '","Tel":"' . $Tel . '","Mail": "","Scancode":"","Comment": "","Services":[{"ServiceCode":"' . $ServiceCode . '","DocCode":"' . $DocCode . '","Start":"' . $Start . '","End":"' . $End . '","Status":"Заказано","Agreement":"' . $Agreement . '", "Docname":"' . $DocName . '"}]}';
