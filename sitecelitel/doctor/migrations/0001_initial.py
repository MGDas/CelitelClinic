    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, upload_to=doctor.models.get_photo, verbose_name='Фото')),
                ('avatar', models.ImageField(blank=True, upload_to=doctor.models.get_photo, verbose_name='Аватарка')),
